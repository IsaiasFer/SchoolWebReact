...
let backButton425px = document.getElementById('backButtonDivices425px');
...
if (screen.width < 425) {
  ...
  openTitle.href =
    '../assets/images/academic/BOLETIN OFICIAL SALTA - DECRETO N° 561_11.pdf';
  openTitle.onclick = '';
...
// let academicContent425px = [studyProgramContent, infoTeachersContent]
...
//         }
//         academicContent425px[optionContent].style.display = 'grid'
//         backButton425px.style.display = 'inline-block'
//         column2Container.className = 'column1Container'
//     }
// }

// backButton425px.addEventListener('click', function comeBack (){
//     for (let i = 0; i < academicButtonsDevicesLessThan425px.length; i++){
...
//     backButton425px.style.display = 'none'
...
if (screen.width < 425) {
  openStudyProgram.addEventListener(
    'click',
    function openStudyProgramContent425px() {
      for (let i = 0; i < academicContent425px.length; i++) {
        academicContent425px[i].style.display = 'none';
      }
      column2Container.className = 'column1Container';
  ...
  openTeachersInfo.addEventListener(
    'click',
    function openTeachersContent425px() {
      for (let i = 0; i < academicContent425px.length; i++) {
        academicContent425px[i].style.display = 'none';
      }
      column2Container.className = 'column1Container';
...
backButton425px.addEventListener('click', function comeBack() {
  for (let i = 0; i < academicContent425px.length; i++) {
    academicContent425px[i].style.display = 'flex';
  }
  studyProgramContent.style.display = 'none';
  infoTeachersContent.style.display = 'none';
  column2Container.className = 'column2Container';
