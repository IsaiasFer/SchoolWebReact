...
import "../styles/shareSection.scss"

function ShareSection(props) {
  return (
    <section className="shareSection">
      <h3 className="content" >Comparte esta noticia!</h3>
      <div className="shareIcons">
        ...
        <a href={`https://api.whatsapp.com/send?text=` + props.link}>
          <img
        ...
        <a
          ...
          href={
            ...
            props.link +
            `&title=&summary=Lee este artículo de la Escuela de Educación Técnica!&source=`
          }
        >
          <img
        ...
        <a
          ...
          href={
            ...
            props.link +
            "&text=Lee este artículo de la Escuela de Educación Técnica!"
          }
        >
          <img
        ...
        <a href={`mailto:?&subject=&body=` + props.link}>
          <img
            alt="Compartir por Correo electrónico"
            className="socialIcons"
            src="data:image/svg+xml;base64,"
          />
        </a>
      </div>
    </section>
